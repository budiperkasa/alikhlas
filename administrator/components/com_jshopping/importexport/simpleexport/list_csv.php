...
<tr class = "row<?php echo $i % 2;?>">
    ...
    <td align="center">
        <a href='index.php?option=com_jshopping&controller=importexport&task=filedelete&ie_id=<?php print $ie_id;?>&file=<?php print $row?>' onclick="return confirm('<?php print _JSHOP_DELETE?>');"><img src='images/publish_x.png'></a>
    </td>
</tr>
<?php
$i++;  
