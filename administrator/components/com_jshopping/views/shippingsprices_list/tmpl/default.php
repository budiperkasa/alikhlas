...
if ($count)
	foreach ($shipping_prices as $sh_price) { ?>
  	<tr>
		...
		<td align="center">
	        <a href='index.php?option=com_jshopping&controller=shippingsprices&task=edit&sh_pr_method_id=<?php echo $sh_price->sh_pr_method_id?>&shipping_id_back=<?php print $this->shipping_id_back?>'><img src='../images/M_images/edit.png'></a>
	   </td>
       <td align="center">
