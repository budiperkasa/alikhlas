...
?>
           ...
           <?php
              ...
              ?>
                  ...
                  <div id="foto_product_<?php print $image->image_id?>">
                    ...
                    <input type = "radio" name = "set_main_image" id = "set_main_image_<?php echo $image->image_id?>" value = "<?php echo $image->image_id?>" <?php if ($row->product_thumb_image == $image->image_thumb) echo 'checked = "checked"';?>/> <label for = "set_main_image_<?php echo $image->image_id?>"><?php echo _JSHOP_SET_MAIN_IMAGE;?></label>
                    <div class="link_delete_foto"><a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_IMAGE;?>')) deleteFotoProduct('<?php echo $image->image_id?>');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE_IMAGE;?></a></div>                  
                  </div>
                  </td>
              <?php
   ...
   <div class="col width-45">
        ...
        <?php
           for ($i = 0; $i < 10; $i++){
             echo '<div style="padding-bottom:6px;"><input type = "file" name = "product_image_'.$i.'" /></div>';
           }
        ?>        
        </fieldset>
    </div>
    ...
    <div class="col width-55">
        ...
        <legend><?php echo _JSHOP_IMAGE_THUMB_SIZE?></legend>
            ...
            <td><label for = "size_1"><?php echo _JSHOP_IMAGE_SIZE_1;?></label></td>
            </tr></table>
            <table class="tmiddle"><tr>
            <td><input type = "radio" name = "size_im_product" value = "3" id = "size_3" onclick = "setOriginalSize('product')" value = "3"/></td>
            <td><label for = "size_3"><?php echo _JSHOP_IMAGE_SIZE_3;?></label></td>
            </tr></table>
            <table class="tmiddle"><tr>
            <td><input type = "radio" name = "size_im_product" id = "size_2" onclick = "setManualSize('product')" value = "2" /></td>
            <td><label for = "size_2"><?php echo _JSHOP_IMAGE_SIZE_2;?></label></td>
            <td> <?php echo JHTML::tooltip(_JSHOP_IMAGE_SIZE_INFO)?></td>
            </tr></table>            
            <?php echo _JSHOP_IMAGE_WIDTH?><br />
            <input type = "text" id = "product_width_image" name = "product_width_image" value = "<?php echo $jshopConfig->image_product_width?>" disabled = "disabled" /><br />
            <?php echo _JSHOP_IMAGE_HEIGHT?><br />
            <input type = "text" id = "product_height_image" name = "product_height_image" value = "<?php echo $jshopConfig->image_product_height?>" disabled = "disabled" />
        </fieldset>
        ...
        <legend><?php echo _JSHOP_IMAGE_SIZE ?></legend>
            ...
            <td><label for = "size_full_1"><?php echo _JSHOP_IMAGE_SIZE_1;?></label></td>
            </tr></table>
            <table class="tmiddle"><tr>
            <td><input type = "radio" name = "size_full_product" id = "size_full_3" onclick = "setFullOriginalSize('product_full')" value = "3" /></td>
            <td><label for = "size_full_3"><?php echo _JSHOP_IMAGE_SIZE_3;?></label></td>
            </tr></table>
            <table class="tmiddle"><tr>
            <td><input type = "radio" name = "size_full_product" id = "size_full_2" onclick = "setFullManualSize('product_full')" value = "2"/></td>
            <td><label for = "size_full_2"><?php echo _JSHOP_IMAGE_SIZE_2;?></label></td>
            <td> <?php echo JHTML::tooltip(_JSHOP_IMAGE_SIZE_INFO)?></td>
            </tr></table>            
            <?php echo _JSHOP_IMAGE_WIDTH?><br />
            <input type = "text" id = "product_full_width_image" name = "product_full_width_image" value = "<?php echo $jshopConfig->image_product_full_width; ?>" disabled = "disabled" /><br />
            <?php echo _JSHOP_IMAGE_HEIGHT?><br />
            <input type = "text" id = "product_full_height_image" name = "product_full_height_image" value = "<?php echo $jshopConfig->image_product_full_height; ?>" disabled = "disabled" />
        </fieldset>
