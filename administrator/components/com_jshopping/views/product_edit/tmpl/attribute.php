    ...
    <script type="text/javascript">
       ...
       if (count($lists['attribs'])){
           ...
           foreach($lists['attribs'] as $k=>$v){
               ...
               print "<td><a href='#' onclick=\"deleteTmpRowAttrib('".$attr_tmp_row_num."');return false;\"><img src='images/publish_x.png' border='0'></a></td>";
               print "</tr>";
           }
       }
       ?>
        ...
        <legend><?php echo _JSHOP_ADD_ATTRIBUT?></legend>
            ...
            <?php foreach($lists['all_attributes'] as $key=>$value){ ?>
                <tr>
                    ...
                    <td><?php echo $value->values_select;?> <img src="images/blank.png" id='preview_attr_img_<?=$value->attr_id?>' width="16" height="16"></td>
                </tr>    
            <?php } ?>
            <tr>
   ...
   ?>
    <?php foreach($lists['all_independent_attributes'] as $ind_attr){?>
        ...
        <tr id='attr_ind_row_<?php print $ind_attr_val->attr_id?>_<?php print $ind_attr_val->attr_value_id?>'>
            ...
            <td><a href='#' onclick="jQuery('#attr_ind_row_<?php print $ind_attr_val->attr_id?>_<?php print $ind_attr_val->attr_value_id?>').remove();return false;"><img src='images/publish_x.png' border='0'></a></td>
        </tr>
        <?php }
        }
        ?>
