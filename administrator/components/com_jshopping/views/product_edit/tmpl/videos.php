   ...
   <table><tr>
    ...
    ?>
        ...
        <div id="video_product_<?php print $video->video_id?>">
            ...
            <div class="link_delete_foto"><a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_VIDEO;?>')) deleteVideoProduct('<?php echo $video->video_id?>');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE_VIDEO;?></a></div>
        </div>
        </td>
    <?php } ?>
    </tr></table>
