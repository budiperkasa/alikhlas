    ...
    <table class="admintable" >
        ...
        <tr class="rows_file_prod_<?php print $file->id?>">
            ...
            <?php if ($file->demo){?>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE;?>')) deleteFileProduct('<?php echo $file->id?>','demo');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE;?></a>
            <?php } ?>
            </td>
        </tr>
        <tr class="rows_file_prod_<?php print $file->id?>">
        ...
        <tr class="rows_file_prod_<?php print $file->id?>">
            ...
            <?php if ($file->file){?>
                <?php print $file->file?>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE;?>')) deleteFileProduct('<?php echo $file->id?>','file');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE;?></a>
            <?php } ?>
            </td>
        </tr>
        <tr class="rows_file_prod_<?php print $file->id?>">
