   ...
   ?>
     ...
     <div class = "jshop_quote" id="foto_category">
        <div>
            ...
            <div class="link_delete_foto"><a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_IMAGE;?>')) deleteFotoCategory('<?php echo $row->category_id?>');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE_IMAGE;?></a></div>
        </div>
     </div>
     <?php } ?>
     <div class="col100">
