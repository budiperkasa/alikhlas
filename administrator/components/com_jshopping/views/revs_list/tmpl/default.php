    ...
    <?php
     ...
     ?>
      <tr class = "row<?php echo $i % 2;?>">
       ...
       <td align="center">
    	<a href='index.php?option=com_jshopping&controller=reviews&task=edit&cid[]=<?php print $row->review_id?>'><img src='../images/M_images/edit.png'></a>
       </td>
       <td align="center">
        <a href='index.php?option=com_jshopping&controller=reviews&task=remove&cid[]=<?php print $row->review_id?>' onclick="return confirm('<?php print _JSHOP_DELETE?>')"><img src='images/publish_x.png'></a>
       </td>
       <td align="center">
