...
<table class="admintable" width = "100%" >
   ...
   <tr>
    ...
    <div id="image_block">
        ...
        <div style="padding-bottom:5px;" class="link_delete_foto"><a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_IMAGE;?>')) deleteFotoLabel('<?php echo $row->id?>');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE_IMAGE;?></a></div>
    </div>
    <?php }?>    
