...
<?php $i = 0; foreach($usergroups as $usergroup){?>
    <tr class = "row<?php echo ($i%2);?>">
		...
		<td align = "center"><?php $default_image = ($usergroup->usergroup_is_default) ? ('tick.png') : ('publish_x.png');?><img src = "images/<?php echo $default_image;?>" /></td>
		<td align="center">
	        <a href='index.php?option=com_jshopping&controller=usergroups&task=edit&usergroup_id=<?php print $usergroup->usergroup_id?>'><img src='../images/M_images/edit.png'></a>
	   </td>
       <td align="center">
