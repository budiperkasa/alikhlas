...
?>
<form action = "index.php?option=com_jshopping&controller=manufacturers" method = "post" name = "adminForm" enctype = "multipart/form-data">
   <?php
   ...
   ?>
     ...
     <div class = "jshop_quote" id="image_manufacturer">
        <div>
            ...
            <div class="link_delete_foto"><a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_IMAGE;?>')) deleteFotoManufacturer('<?php echo $row->manufacturer_id?>');return false;"><img src="images/publish_x.png"> <?php print _JSHOP_DELETE_IMAGE;?></a></div>
        </div>
     </div>
     <?php } ?>
     ...
     <table class="admintable" >
       ...
       <tr>
         ...
         <td>
           ...
           <label for = "size_1"><?php echo _JSHOP_IMAGE_SIZE_1;?></label><br />
           <input type = "radio" name = "size_im_category" value = "3" id = "size_3" onclick = "setOriginalSize('category')" value = "3"/>
           <label for = "size_3"><?php echo _JSHOP_IMAGE_SIZE_3;?></label><br />
