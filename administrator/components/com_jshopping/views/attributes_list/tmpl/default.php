...
<?php
 ...
 ?>
  <tr class = "row<?php echo $i % 2;?>">
   ...
   <td>
    <?php if (!$row->count_values) {?><img src="images/disabled.png" alt="" /><?php }?>
   ...
   <td>
    ...
    <?php
      if ($i != 0) echo '<a href = "index.php?option=com_jshopping&controller=attributes&task=order&id=' . $row->attr_id . '&order=up&number=' . $row->attr_ordering . '"><img width="12" height="12" border="0" alt="' . _JSHOP_UP . '" src="images/uparrow.png"/></a>';
    ?>
   </td>
   <td align = "left" width = "20">
      <?php
        if ($i++ != $count - 1) echo '<a href = "index.php?option=com_jshopping&controller=attributes&task=order&id=' . $row->attr_id . '&order=down&number=' . $row->attr_ordering . '"><img width="12" height="12" border="0" alt="' . _JSHOP_DOWN . '" src="images/downarrow.png"/></a>';
      ?>
   </td>
   <td align="center">
        <a href='index.php?option=com_jshopping&controller=attributes&task=edit&attr_id=<?php print $row->attr_id;?>'><img src='../images/M_images/edit.png'></a>
   </td>
   <td align="center">
