...
<thead>
  <tr>
    ...
    <th colspan = "3" width = "40">
      ...
      <a href="javascript:saveorder(<?php echo count( $countries ) - 1;?>,'saveorder')" title="Save Order"><img src="images/filesave.png" alt="Save Order"/></a>
    </th>
    <th width = "50">
 ...
 foreach($countries as $country){
  ...
  <tr class = "row<?php echo $i % 2;?>">
   ...
   <td align = "right" width = "20">
    <?php
      if ($i != 0) echo '<a href = "index.php?option=com_jshopping&controller=countries&task=order&id=' . $country->country_id . '&order=up&number=' . $country->ordering . '"><img width="12" height="12" border="0" alt="' . _JSHOP_UP . '" src="images/uparrow.png"/></a>';
    ?>
   </td>
   <td align = "left" width = "20">
      <?php
        if ($i != $count - 1) echo '<a href = "index.php?option=com_jshopping&controller=countries&task=order&id=' . $country->country_id . '&order=down&number=' . $country->ordering . '"><img width="12" height="12" border="0" alt="' . _JSHOP_DOWN . '" src="images/downarrow.png"/></a>';
      ?>
   </td>
   ...
   <td align="center">
	...
	<td align="center">
		<a href='index.php?option=com_jshopping&controller=countries&task=edit&country_id=<?php print $country->country_id;?>'><img src='../images/M_images/edit.png'></a>
	</td>
	<td align="center">
