...
<?php
 ...
 foreach($languages as $language){
  ...
  <tr class = "row<?php echo $i % 2;?>">
   ...
   <td align="center">
     <?php if ($this->default_front == $language->language) {?><img src="templates/khepri/images/menu/icon-16-default.png"><?php }?>
   </td>
   <td align="center">
     <?php if ($this->defaultLanguage == $language->language) {?><img src="templates/khepri/images/menu/icon-16-default.png"><?php }?>
   </td>
   <td align="center">
     <?php
