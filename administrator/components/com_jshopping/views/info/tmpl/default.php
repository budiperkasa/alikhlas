<table width="100%" style="background: #EBF0F3;">
<tr>
 ...
 <td valign="top" style="padding:5px;">
    <div style="padding-left:5px;padding-bottom:30px;">
        ...
        <div style="padding-top:5px;padding-left:5px;font-size:14px;"><b>Version <?php print $this->data['version'];?></b></div>
    </div>
    ...
    <div style="padding-left:4px;">
        ...
        <tr>
        <td valign="top"><img src="components/com_jshopping/images/shop.png" align="left" border="0" style="margin-right:8px;"></td>
        <td><div style="padding-top:2px;">
