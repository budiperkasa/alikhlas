 ...
 ?>
  <tr class = "row<?php echo $i % 2;?>">
   ...
   <td align = "right" width = "20">
    <?php
      if ($i != 0) echo '<a href = "index.php?option=com_jshopping&controller=attributesvalues&task=order&id=' . $row->value_id . '&order=up&number=' . $row->value_ordering . '&attr_id=' . $attr_id . '"><img width="12" height="12" border="0" alt="' . _JSHOP_UP . '" src="images/uparrow.png"/></a>';
    ?>
   </td>
   <td align = "left" width = "20">
      <?php
        if ($i++ != $count - 1) echo '<a href = "index.php?option=com_jshopping&controller=attributesvalues&task=order&id=' . $row->value_id . '&order=down&number=' . $row->value_ordering . '&attr_id=' . $attr_id . '"><img width="12" height="12" border="0" alt="' . _JSHOP_DOWN . '" src="images/downarrow.png"/></a>';
      ?>
   </td>
   <td align="center">
        <a href="index.php?option=com_jshopping&controller=attributesvalues&task=edit&value_id=<?php echo $row->value_id; ?>&attr_id=<?php echo $attr_id?>"><img src='../images/M_images/edit.png'></a>
   </td>
   <td align="center">
