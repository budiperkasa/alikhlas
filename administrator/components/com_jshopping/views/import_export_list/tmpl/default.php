...
<tr class = "row<?php echo $i % 2;?>">
    ...
    <td align="center">
        <a href='index.php?option=com_jshopping&controller=importexport&task=remove&cid=<?php print $row->id?>' onclick="return confirm('<?php print _JSHOP_DELETE?>');"><img src='images/publish_x.png'></a>
    </td>    
    <td align="center">
        <?php print $row->id;?>
    </td>
