...
<?php
 foreach($taxes as $tax){
  ...
  <tr class = "row<?php echo $i % 2;?>">
   ...
   <td align="center">
        <?php print "<a href='index.php?option=com_jshopping&controller=exttaxes&task=edit&id=".$tax->id."&back_tax_id=".$this->back_tax_id."'><img src='../images/M_images/edit.png'></a>"?>
   </td>
   <td align="center">
        <?php print $tax->id;?>
   </td>
