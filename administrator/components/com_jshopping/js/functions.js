...
function addNewPrice(){
    ...
    html += '<td align="center"><a href="#" onclick="delete_add_price('+add_price_num+');return false;"><img src="images/publish_x.png" border="0"/></a></td>';
    html += '</tr>';
...
function addFieldShPrice(){    
    ...
    html += '<td style="text-align:center"><a href="#" onclick="delete_shipping_weight_price_row('+shipping_weight_price_num+');return false;"><img src="images/publish_x.png" border="0"/></a></td>';    
    html += '</tr>';
...
function addAttributValue2(id){
    ...
    html+="<td><a href='#' onclick=\"jQuery('#attr_ind_row_"+id+"_"+value_id+"').remove();return false;\"><img src='images/publish_x.png' border='0'></a></td>";    
    html += "</tr>";    
...
function addAttributValue(){    
    ...
    for(var j=0; j<combination; j++){
        ...
        html+="<td><a href='#' onclick=\"deleteTmpRowAttrib('"+attr_tmp_row_num+"');return false;\"><img src='images/publish_x.png' border='0'></a></td>";
...
function changeAttrAdmin(aid, aval){
    if (aval==0) {
        jQuery("#preview_attr_img_"+aid).attr('src',"images/blank.png"); 
        return 1;
    }
