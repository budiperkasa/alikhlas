...
<div id="page-<?php echo $this->_name;?>" class="pluginSettings"
	...
	function setTableIds()
	{
		if (!isset($this->tableids)) {
			$params =& $this->getParams();
			$this->tableids = $params->get('chart_table', array(), '_default', 'array');
		}
	}
