...
class FabrikModelFabrikTextarea extends FabrikModelElement {
	...
	{
		return $this->renderTableData($value, new stdClass());
	}
	...
	function elementJavascript($repeatCounter)
	{
		...
		//tinymce version changed in J 1.5.12 - all of its methods have changed! (ok in J1.6+)
		$opts->tinymce = ($version->RELEASE == '1.5' && $version->DEV_LEVEL >= 12) ? 3: 2;
