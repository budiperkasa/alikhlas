...
class FabrikModelCSVExport {
	...
	{
		$this->model->setId(JRequest::getInt('tableid'));
		$table 	=& $this->model->getTable();
					...
					if ($fullname == $heading || $fullname . "_raw" == $heading) {
						...
						switch ($hformat) {
							...
							case '1':
								...
								break;
							case '2':
								$headingLabel = $elementModel->getParams()->get('element_alt_table_heading');
