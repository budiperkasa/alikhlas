...
define('_JSHOP_REGISTRATION', 'Anmeldung');
...
define('_JSHOP_REGWARN_TITLE', 'Bitte wählen Sie den Titel aus');
...
define('_JSHOP_REGWARN_TITLE_DELIVERY', 'Bitte wählen Sie den Titel den Liefer aus');
...
define('_JSHOP_NO_ORDERS', 'Sie haben noch keine Bestellungen');
...
define('_JSHOP_YOUR_REVIEW_SAVE','Ihr Kommentar wurde gespeichert und wird nach der Bestätigung Administrator angezeigt werden');
...
define('_JSHOP_ERROR_EXIST_QTY_PRODUCT_IN_CART', 'Einige Produkte sind nicht in der gewünschten Menge lieferbar.<br/>Ihr Warenkorb bereits %s Produkte.<br/>Die Höchstbestellmenge beträgt  zur Zeit %s.');
